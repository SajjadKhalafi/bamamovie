...
@section('content')
    <div class="movie-info border-b border-gray-800">
        <div class="container mx-auto px-4 py-16 flex flex-col md:flex-row">
            <div class="flex-none">
                <img src="{{ asset('storage/movies/posters/' . $movie['poster_path']) }}"
            ...
            <div class="md:ml-24">
                ...
                <div class="flex flex-wrap items-center text-gray-400 text-sm pt-2">
                ...
                <div class="mt-12">
                    ...
                    <div class="flex mt-4">
                        <div class="mr-20">
                            <div>David Fincher</div>
                            <div class="text-sm text-gray-400">Director</div>
                        </div>

                        <div class="mr-20">
                            <div>Chuck Palahniuk</div>
