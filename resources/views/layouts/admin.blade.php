                    ...
                    <li class="flex-1 md:flex-none md:mr-3">
                        <div class="relative inline-block">
                            ...
                            <div id="myDropdown" class="dropdownlist absolute bg-gray-800 text-white right-0 mt-3 p-2 overflow-auto z-30 invisible">
                                <a href="{{ route('profile.edit') }}" class="p-1 hover:bg-gray-800 text-white text-sm flex items-center flex-nowrap"><i class="fa fa-user fa-fw pr-6"></i> Profile</a>
                                <div class="border border-gray-800"></div>
                                <form action="{{ route('logout') }}" method="POST">
                                    @csrf
                                    <button
                                        class="p-1 hover:bg-gray-800 text-white text-sm flex items-center flex-nowrap"><i class="fas fa-sign-out-alt fa-fw pr-6"></i> Log Out</button>
                                </form>
                            </div>
                        </div>
                    </li>
